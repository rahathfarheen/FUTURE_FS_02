...
| Bonus: simple analytics (total leads, conversions) | Stats bar at the top of the dashboard |
...
- **Pipeline view** — every lead shows a 3-step stage rail (New → Contacted → Converted); leads that fall through show a "Lost" badge.
